...
interface PillNavProps {
    ...
    mobileLogoMenu?: React.ReactNode;
}
...
export function PillNav({
    ...
    useEffect(() => {
        const layout = () => {
            circleRefs.current.forEach((circle, i) => {
                ...
                // Simple geometry for the hover circle effect
                ...
                // Kill existing timeline if resizing
    ...
    // Next.js Link handles internal links, <a> for external/hash
        ...
        <div className={`pill-nav-container ${className}`} style={cssVars}>
            <nav className="pill-nav" aria-label="Primary">
                ...
                {isRouterLink(logoHref) ? (
                    ...
                    >
                        <div ref={logoWrapperRef} className="pill-logo-content">
                            {typeof logo === 'string' ? (
