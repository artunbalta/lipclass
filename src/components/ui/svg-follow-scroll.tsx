  ...
  return (
    ...
    >
      <div className="mt-42 relative flex w-fit flex-col items-center justify-center gap-5 text-center">
        <h1 className="relative z-10 text-7xl font-medium tracking-[-0.08em] lg:text-9xl" style={{ fontFamily: "var(--font-plus-jakarta-sans), system-ui, sans-serif" }}>
          The Stroke <br /> That follows the <br />
          Scroll Progress
        </h1>
        <p className="relative z-10 max-w-2xl text-xl font-medium text-[#1F3A4B]" style={{ fontFamily: "var(--font-plus-jakarta-sans), system-ui, sans-serif" }}>
      ...
      <div className="rounded-4xl w-full translate-y-[200vh] bg-[#1F3A4B] pb-10 text-[#FAFDEE]" style={{ fontFamily: "var(--font-plus-jakarta-sans), system-ui, sans-serif" }}>
